          ...
          if ($_SESSION['account_type'] == 'student') {
            ...
            if ($count_user_bookings == 0 && $vacancies > 0) {
              ...
              if ($result_booking) {
                ...
                $student_msg .= "\nUse the link below to go to your dashboard to view your booking details or to contact the property owner.\n";
                ...
                $owner_msg .= "\nA new booking has been made at your property - " . $name . "\n";
                $owner_msg .= "\nYour new tenant will contact you to arrange for payment. You can approve the new booking once you have received payment for rent. Bookings that are not approved within 48 hours are automatically cancelled.\n";
